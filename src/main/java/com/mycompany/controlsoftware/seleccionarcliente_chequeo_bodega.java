 ...
 * @author Usuario
 */
public class seleccionarcliente_chequeo_bodega extends javax.swing.JInternalFrame {
    ...
    public seleccionarcliente_chequeo_bodega() {
...
//        
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(rtn)
                        .addGap(18, 18, 18)
                        .addComponent(activo, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            ingresar_chequeo_pedido.codcliente.setText(u);
            ingresar_chequeo_pedido.descliente.setText(v);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionarcliente_chequeo_bodega.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionarcliente_chequeo_bodega().setVisible(true);
            }
        });
    }
