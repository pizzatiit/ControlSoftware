 ...
 * @author Usuario
 */
public class mantenimiento_grupos extends javax.swing.JInternalFrame {
    ...
    public mantenimiento_grupos() {
        ...
        initComponents();
        bd.LlenarTabla("select CODCATEGORIA AS COD, CATEGORIA AS GRUPO FROM CATEGORIA where cia=" + ControlSoftware.cia, Productos);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!bd.versiesta("select * from role_usuario inner join role on role.id=role_usuario.roleid inner join usuario on usuario.cod_user=role_usuario.usuarioid inner join role_permiso on role_permiso.roleid=role.id inner join permisos on permisos.id=role_permiso.permisoid where permisos.id=" + perm + " and role_usuario.cia=" + ControlSoftware.cia + " and usuario.cod_user=" + ControlSoftware.us)) {
            JOptionPane.showMessageDialog(null, "Usted no tiene permiso de ingresar grupos de productos.");
            return;
        }

        i_grupo l = new i_grupo();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        u_grupo l = new u_grupo("" + Productos.getValueAt(Productos.getSelectedRow(), 0));
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!buscar.getText().isEmpty()) {
            bd.LlenarTabla("select CODCATEGORIA AS COD, CATEGORIA AS GRUPO FROM CATEGORIA CATEGORIA like '%" + buscar.getText() + "%' and cia=" + ControlSoftware.cia, Productos);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       if( bd.versiesta("select idcategoria from producto where idcategoria="+Productos.getValueAt(Productos.getSelectedRow(), 0)+ " and cia="+ControlSoftware.cia)){
           JOptionPane.showMessageDialog(null,"Este grupo ha sido asignado a un producto, por ende no se puede eliminar.");
           return;
       }
       bd.EjecutarConsultas("DELETE FROM CATEGORIA WHERE CODCATEGORIA="+Productos.getValueAt(Productos.getSelectedRow(), 0)+" and cia="+ControlSoftware.cia);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mantenimiento_grupos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mantenimiento_grupos().setVisible(true);
            }
        });
    }
