 ...
 * @author Usuario
 */
public class seleccionar_categoria2 extends javax.swing.JInternalFrame {

    /**
     * Creates new form seleccionar_categoria
     */BaseDeDatos bd = new BaseDeDatos();
    public seleccionar_categoria2() {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            i_subgrupo.codcat.setText(cod.getText());
            i_subgrupo.descat.setText(descripcion.getText());
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_categoria2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_categoria2().setVisible(true);
            }
        });
    }
