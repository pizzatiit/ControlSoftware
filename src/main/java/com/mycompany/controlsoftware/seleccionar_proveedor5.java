 ...
 * @author Usuario
 */
public class seleccionar_proveedor5 extends javax.swing.JInternalFrame {

    /**
     * Creates new form seleccionar_proveedor
     */
    BaseDeDatos bd = new BaseDeDatos();
    public seleccionar_proveedor5() {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            recibo1.codcliente.setText(cod.getText());
            recibo1.descliente.setText(descripcion.getText());
            String facts[] = bd.Llenar("select id_ordencompra from ordencompra where saldo>0 and estado!=0 and id_proveedor=" + cod.getText() + " and cia=" + ControlSoftware.cia, "id_ordencompra");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_proveedor5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_proveedor5().setVisible(true);
            }
        });
    }
