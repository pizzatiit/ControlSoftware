 ...
 * @author Usuario
 */
public class configuraciones_company_ajustes extends javax.swing.JInternalFrame {
    ...
    public configuraciones_company_ajustes( ) {
...
public static String hashPassword(String password) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         bd.EjecutarConsultas("delete from company_configuraciones where companyid=" + ControlSoftware.cia );

        for (int i = 0; i < jTable1.getRowCount(); i++) {
            if (("" + jTable1.getValueAt(i, 2)).equals("true")) {
                bd.EjecutarConsultas("INSERT INTO `company_configuraciones`(`companyid`, `configuracionid`, `estado`) VALUES ('" + ControlSoftware.cia + "','" + jTable1.getValueAt(i, 0) + "','1')");
            }
        }
        JOptionPane.showMessageDialog(null, "¡Ajustes actualizados con éxito!"); 
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(configuraciones_company_ajustes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new configuraciones_company_ajustes( ).setVisible(true);
            }
        });
    }
