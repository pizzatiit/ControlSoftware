 ...
 * @author Usuario
 */
public class i_departamento extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("INGRESAR DEPARTAMENTO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bd.EjecutarConsultas("INSERT INTO `departamento`(`departamento`, `comodin`, `estado`) VALUES ('" + nombre.getText() + "','" + comodin.getText() + "','1')");
        JOptionPane.showMessageDialog(null, "¡Departamento ingresado con éxito!");
 ...
 if (comodin.getText().length() > 254) {
    ...
    private void comodinKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_comodinKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_comodinKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(i_departamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new i_departamento().setVisible(true);
            }
        });
    }
