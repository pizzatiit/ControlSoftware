 ...
 * @author Usuario
 */
public class seleccionarcliente3 extends javax.swing.JInternalFrame {
...
//        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/back.png")));
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(buscar, javax.swing.GroupLayout.PREFERRED_SIZE, 406, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
           ...
           modificar_orden_de_pedido.codcliente.setText(u);
            modificar_orden_de_pedido.descliente.setText(v);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionarcliente3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionarcliente3().setVisible(true);
            }
        });
    }
