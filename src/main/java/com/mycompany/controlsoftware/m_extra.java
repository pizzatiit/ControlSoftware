 ...
 * @author Usuario
 */
public class m_extra extends javax.swing.JInternalFrame {
    ...
    public m_extra() {
        ...
        initComponents();
        bd.LlenarTabla("select id_extra as COD, extra as EXTRA, REFERENCIA AS REFERENCIA from EXTRA WHERE CIA="+ControlSoftware.cia, vendedor);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        u_extra l = new u_extra("" + vendedor.getValueAt(vendedor.getSelectedRow(), 0));
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(m_extra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
