...
//        }
        ...
        String codu = bd.doble("INSERT INTO `usuario`(`user`, `password`, `cod_role`, `cia`, `state`, `nombre`,`vendedorid`) VALUES ('" + usuario.getText() + "','" + hashPassword(pass) + "','2','" + ControlSoftware.cia + "','1','" + nombre.getText() + "','1')", "SELECT @@IDENTITY AS 'id'");
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            if (("" + jTable1.getValueAt(i, 2)).equals("true")) {
