...
public class modificar_orden_de_pedido extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String codproductoreservado[] = bd.Llenar("select idproducto from detalle_orden_de_pedido where id_orden_de_pedido=" + opg + " and cia=" + ControlSoftware.cia, "idproducto");
        String canproductoreservado[] = bd.Llenar("select cantidad from detalle_orden_de_pedido where id_orden_de_pedido=" + opg + " and cia=" + ControlSoftware.cia, "cantidad");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (bd.versiesta("select idproducto from detalle_orden_de_pedido where idproducto=" + idprod.getText() + " and id_orden_de_pedido=" + opg + " and cia=" + ControlSoftware.cia)) {
            existencia += Double.parseDouble(bd.valor("select cantidad from detalle_orden_de_pedido where idproducto=" + idprod.getText() + " and id_orden_de_pedido=" + opg + " and cia=" + ControlSoftware.cia));
        }
