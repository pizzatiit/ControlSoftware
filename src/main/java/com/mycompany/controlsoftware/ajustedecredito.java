 ...
 * @author Usuario
 */
public class ajustedecredito extends javax.swing.JInternalFrame {
    ...
    public ajustedecredito(String cl, String f) {
        ...
        if (bd.valor("select MAX(cast(numero_recibo as unsigned))+1 from recibopago where tipo=4 and cia=" + ControlSoftware.cia) == null) {
            nrecibo.setText("1");
        } else {
            nrecibo.setText(String.format("%.0f", (Double.parseDouble(bd.valor("select MAX(cast(numero_recibo as unsigned))+1 from recibopago where tipo=4 and cia=" + ControlSoftware.cia)))));
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("INGRESAR AJUSTE DE CRÉDITO");
    ...
    private void clieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clieActionPerformed
        // TODO add your handling code here:
        seleccionarcliente_ajustedecredito l = new seleccionarcliente_ajustedecredito();
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ajustedecredito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ajustedecredito("", "").setVisible(true);
            }
        });
    }
