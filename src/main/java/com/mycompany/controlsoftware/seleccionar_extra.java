 ...
 * @author Usuario
 */
public class seleccionar_extra extends javax.swing.JFrame {

   BaseDeDatos bd = new BaseDeDatos();
   int y;
    public seleccionar_extra(int cambio) {
        ...
        bd.LlenarTabla("select id_extra as COD, extra as EXTRA, referencia as REF from extra where cia="+ControlSoftware.cia, jTable1);
        y=cambio;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("SELECCIONE EXTRA");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
           if (y==1){
           // nuevocliente.codcat4.setText(cod.getText());
           // nuevocliente.descat4.setText(descripcion.getText());
            }if(y==2){
          //  modificarcliente.codcat4.setText(cod.getText());
           // modificarcliente.descat4.setText(descripcion.getText());
            }
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_extra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_extra(1).setVisible(true);
            }
        });
    }
