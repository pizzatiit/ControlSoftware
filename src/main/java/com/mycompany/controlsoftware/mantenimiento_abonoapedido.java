 ...
 */
public class mantenimiento_abonoapedido extends javax.swing.JInternalFrame {
    ...
    public mantenimiento_abonoapedido() {
        ...
        initComponents();
        bd.LlenarTabla("select r.id AS COD, r.nabono AS N_ABONO, CASE r.tipopago WHEN '0' THEN 'FACTURA' WHEN '1' THEN 'FLETE MARITIMO' WHEN '2' THEN 'COSTOS EXTRA' WHEN '3' THEN 'CARGOS DE SEGURO' WHEN '4' THEN 'FLETE AEREO' END AS TIPO, O.NFACTURA AS ORDEN, P.PROVEEDOR as PROVEEDOR, r.monto as TOTAL, r.fecha as FECHA, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM abonoapedido r inner join ordenentransito o on o.id=r.idfact inner join proveedor p on o.idproveedor=p.idproveedor  where r.cia=" + ControlSoftware.cia + " order by r.fecha desc", Productos);
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "POR PROVEEDOR", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        pcliente.setText("POR PROVEEDOR");
        ...
        jLabel10.setText("MANTENIMIENTO DE ABONOS A ORDENES");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (ninguno.isSelected()) {
                ...
                bd.LlenarTabla("select r.id AS COD, r.nabono AS N_ABONO, CASE r.tipopago WHEN '0' THEN 'FACTURA' WHEN '1' THEN 'FLETE MARITIMO' WHEN '2' THEN 'COSTOS EXTRA' WHEN '3' THEN 'CARGOS DE SEGURO' WHEN '4' THEN 'FLETE AEREO' END AS TIPO, O.NFACTURA AS ORDEN, P.PROVEEDOR as PROVEEDOR, r.monto as TOTAL, r.fecha as FECHA, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM abonoapedido r inner join ordenentransito o on o.id=r.idfact inner join proveedor p on o.idproveedor=p.idproveedor  where r.cia=" + ControlSoftware.cia + " and r.nabono between " + dnumero.getText() + " and " + hnumero.getText() + " order by r.fecha desc", Productos);
                ...
                if (date2.compareTo(date1) == -1) {
                    ...
                    bd.LlenarTabla("select r.id AS COD, r.nabono AS N_ABONO, CASE r.tipopago WHEN '0' THEN 'FACTURA' WHEN '1' THEN 'FLETE MARITIMO' WHEN '2' THEN 'COSTOS EXTRA' WHEN '3' THEN 'CARGOS DE SEGURO' WHEN '4' THEN 'FLETE AEREO' END AS TIPO, O.NFACTURA AS ORDEN, P.PROVEEDOR as PROVEEDOR, r.monto as TOTAL, r.fecha as FECHA, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM abonoapedido r inner join ordenentransito o on o.id=r.idfact inner join proveedor p on o.idproveedor=p.idproveedor  where r.cia=" + ControlSoftware.cia + " and r.fecha between '" + Date_Format.format(dfecha.getDate()) + "' and '" + Date_Format.format(hfecha.getDate()) + "'" + " order by r.fecha desc", Productos);
                }
            } else if (pcliente.isSelected() && !cliente.getText().isEmpty()) {
                bd.LlenarTabla("select r.id AS COD, r.nabono AS N_ABONO, CASE r.tipopago WHEN '0' THEN 'FACTURA' WHEN '1' THEN 'FLETE MARITIMO' WHEN '2' THEN 'COSTOS EXTRA' WHEN '3' THEN 'CARGOS DE SEGURO' WHEN '4' THEN 'FLETE AEREO' END AS TIPO, O.NFACTURA AS ORDEN, P.PROVEEDOR as PROVEEDOR, r.monto as TOTAL, r.fecha as FECHA, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM abonoapedido r inner join ordenentransito o on o.id=r.idfact inner join proveedor p on o.idproveedor=p.idproveedor  where r.cia=" + ControlSoftware.cia + " and p.proveedor like '%" + cliente.getText() + "%'" + " order by r.fecha desc", Productos);
                ...
                if (date2.compareTo(date1) == -1) {
                    ...
                    bd.LlenarTabla("select r.id AS COD, r.nabono AS N_ABONO, CASE r.tipopago WHEN '0' THEN 'FACTURA' WHEN '1' THEN 'FLETE MARITIMO' WHEN '2' THEN 'COSTOS EXTRA' WHEN '3' THEN 'CARGOS DE SEGURO' WHEN '4' THEN 'FLETE AEREO' END AS TIPO, O.NFACTURA AS ORDEN, P.PROVEEDOR as PROVEEDOR, r.monto as TOTAL, r.fecha as FECHA, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM abonoapedido r inner join ordenentransito o on o.id=r.idfact inner join proveedor p on o.idproveedor=p.idproveedor  where r.cia=" + ControlSoftware.cia + " and p.proveedor like '%" + cliente.getText() + "%'" + " and r.fecha between '" + Date_Format.format(dfecha.getDate()) + "' and '" + Date_Format.format(hfecha.getDate()) + "'" + " and r.nabono between " + dnumero.getText() + " and " + hnumero.getText() + " order by r.fecha desc", Productos);
                }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        abonoapedido l = new abonoapedido("0");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Ingreso_de_credenciales dialog = new Ingreso_de_credenciales("177");
        ...
        ustemp = bd.valor("select user from usuario where cod_user=" + dialog.usuariot + " and cia=" + ControlSoftware.cia);
        ...
        try {
            ...
            if (Productos.getValueAt(Productos.getSelectedRow(), 7).equals("ANULADO")) {
            ...
            int opc = 0;
            opc = JOptionPane.showConfirmDialog(null, "Desea anular este recibo? se eliminarán todos los pagos a todas las ordenes.");
            if (opc == 0) {
                String fac=bd.valor("select idfact from abonoapedido where id="+Productos.getValueAt(Productos.getSelectedRow(), 0) + " and cia=" + ControlSoftware.cia);
                Double monto = Double.parseDouble(bd.valor("select monto from abonoapedido where id=" + Productos.getValueAt(Productos.getSelectedRow(), 0) + " and cia=" + ControlSoftware.cia));
                bd.EjecutarConsultas("update ordenentransito set saldo=saldo+" + monto + " where id=" + fac + " and cia=" + ControlSoftware.cia);
                if (bd.valor("select saldo from ordenentransito where id=" + fac).equals(bd.valor("select gtotal from ordenentransito where id=" + fac))) {
                    bd.EjecutarConsultas("update ordenentransito set estado=1 where id=" + fac);
                }
                if (!bd.valor("select saldo from ordenentransito where id=" + fac).equals(bd.valor("select gtotal from ordenentransito where id=" + fac)) && !bd.valor("select saldo from ordenentransito where id=" + fac).equals("0.00")) {
                    bd.EjecutarConsultas("update ordenentransito set estado=2 where id=" + fac + " and cia=" + ControlSoftware.cia);
                }
                if (bd.valor("select saldo from ordenentransito where id=" + fac).equals("0.00")) {
                    bd.EjecutarConsultas("update ordenentransito set estado=3 where id=" + fac);
                }
                System.out.println("realizado");

                bd.EjecutarConsultas("update abonoapedido set saldofinal=saldofinal+monto, monto=0, estado=0, observacion='Abono anulado por: " + ustemp + "' where id=" + Productos.getValueAt(Productos.getSelectedRow(), 0) + " and cia=" + ControlSoftware.cia);
                JOptionPane.showMessageDialog(null, "Abono anulado con éxito");
            }
            jButton1.doClick();
        } catch (Exception e) {
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        Ingreso_de_credenciales dialog = new Ingreso_de_credenciales("178");
        dialog.setModal(true);
        dialog.setVisible(true);  // AQUI DEBE ESPERAR A QUE INGRESE LOS DATOS PARA HACER LA SIGUIENTE CONDICION
        ...
        try {
            if (!Productos.getValueAt(Productos.getSelectedRow(), 7).equals("ANULADO")) {
                JOptionPane.showMessageDialog(null, "No se puede eliminar este pago porque no ha sido anulado.");
                return;
            }
            ...
            if (opc == 0) {
                ...
                bd.EjecutarConsultas("delete from abonoapedido where id=" + r);
                jButton1.doClick();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mantenimiento_abonoapedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mantenimiento_abonoapedido().setVisible(true);
            }
        });
    }
