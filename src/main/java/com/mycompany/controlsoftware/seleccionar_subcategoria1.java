 ...
 * @author Usuario
 */
public class seleccionar_subcategoria1 extends javax.swing.JInternalFrame {

    /**
     * Creates new form seleccionar_subcategoria
     */
    BaseDeDatos bd = new BaseDeDatos();
    public seleccionar_subcategoria1(String cod) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            modificarproducto.codsub.setText(cod.getText());
            modificarproducto.dessub.setText(descripcion.getText());
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_subcategoria1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_subcategoria1("1").setVisible(true);
            }
        });
    }
