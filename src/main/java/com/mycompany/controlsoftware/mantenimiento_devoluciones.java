    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (ninguno.isSelected()) {
                bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia+" AND FACTURA.CONDICIONPAGO=0", Productos);
            } else if (pnumero.isSelected() && !dnumero.getText().isEmpty() && !hnumero.getText().isEmpty()) {
                bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia + " AND FACTURA.CONDICIONPAGO=0 and devolucion.n_devolucion between " + dnumero.getText() + " and " + hnumero.getText(), Productos);
                ...
                if (date2.compareTo(date1) == -1) {
                    ...
                    bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia + " AND FACTURA.CONDICIONPAGO=0 and devolucion.fecha_sistema between '" + Date_Format.format(dfecha.getDate()) + "' and '" + Date_Format.format(hfecha.getDate()) + "'", Productos);
                }
            } else if (pcliente.isSelected() && !cliente.getText().isEmpty()) {
                bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia + " AND FACTURA.CONDICIONPAGO=0 and c.nombre like '%" + cliente.getText() + "%'", Productos);
                ...
                if (date2.compareTo(date1) == -1) {
                    ...
                    bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia + " AND FACTURA.CONDICIONPAGO=0 and c.nombre like '%" + cliente.getText() + "%'" + " and devolucion.fecha_sistema between '" + Date_Format.format(dfecha.getDate()) + "' and '" + Date_Format.format(hfecha.getDate()) + "'" + " and devolucion.n_devolucion between " + dnumero.getText() + " and " + hnumero.getText(), Productos);
                }

            } else {
                bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where FACTURA.CONDICIONPAGO=0 AND devolucion.cia=" + ControlSoftware.cia, Productos);
