 ...
 * @author Usuario
 */
public class seleccionar_banco extends javax.swing.JFrame {

    /**
     * Creates new form seleccionar_categoria
     */BaseDeDatos bd = new BaseDeDatos();
     int y;
    public seleccionar_banco( ) {
...
//            pagocontado.jCheckBox1.setSelected(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_banco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_banco( ).setVisible(true);
            }
        });
    }
