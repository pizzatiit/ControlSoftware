 ...
 * @author Usuario
 */
public class configuraciones_cai_facturas extends javax.swing.JInternalFrame {
    ...
    public configuraciones_cai_facturas() {
        ...
        initComponents();
        bd.LlenarTabla("select ID AS ID, CAI AS CAI, FECHA_INICIAL AS FECHA_INICIAL, FECHA_FINAL AS FECHA_FINAL, RANGO_INICIAL AS RANGO_INICIAL, RANGO_FINAL AS RANGO_FINAL, FECHA_ASIGNACION AS ASIGNADO, FECHA_CAMBIO AS SUSTITUIDO, CASE ESTADO WHEN '0' THEN 'INACTIVO' WHEN '1' THEN 'ACTIVO' END AS ESTADO from historico_caifactura where cia=" + ControlSoftware.cia, jTable1);
        autoajustar();
    }
...
// Itera sobre las columnas y ajusta su tamaño al contenido
    ...
    private void confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarActionPerformed
        ...
        modificarcaifac l = new modificarcaifac("" + jTable1.getValueAt(jTable1.getSelectedRow(), 0));
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(configuraciones_cai_facturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new configuraciones_cai_facturas().setVisible(true);
            }
        });
    }
