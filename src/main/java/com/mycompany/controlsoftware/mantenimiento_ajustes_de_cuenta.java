 ...
 */
public class mantenimiento_ajustes_de_cuenta extends javax.swing.JInternalFrame {
    ...
    public mantenimiento_ajustes_de_cuenta() {
        ...
        bd.LlenarTabla("select r.id_recibo AS COD, r.numero_recibo AS NRECIBO, CASE r.tipo WHEN '4' THEN 'AJUSTE-CREDITO' WHEN '5' THEN 'AJUSTE-DEBITO' END AS TIPO, c.nombre as CLIENTE, v.vendedor as VENDEDOR, r.total as TOTAL, r.fecha as FECHA_EMISION, r.fechaingreso as FECHA_INGRESO, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM recibopago r inner join vendedor v on r.idvendedor=v.id_vendedor inner join clientes c on r.idcliente=c.idcliente where (r.tipo=4 or r.tipo=5) and r.cia=" + ControlSoftware.cia + " order by r.fechaingreso desc", Productos);
        Productos.setDefaultRenderer(Object.class, new MiRenderer1());
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(pcliente, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel10.setText("MANTENIMIENTO DE AJUSTES DE CUENTA");
        ...
        jButton2.setText("AJUSTE DE DEBITO");
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/nuevo24.png"))); // NOI18N
        jButton4.setText("AJUSTE DE CRÉDITO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (ninguno.isSelected()) {
                ...
                bd.LlenarTabla("select r.id_recibo AS COD, r.numero_recibo AS NRECIBO, CASE r.tipo WHEN '4' THEN 'AJUSTE-CREDITO' WHEN '5' THEN 'AJUSTE-DEBITO' END AS TIPO, c.nombre as CLIENTE, v.vendedor as VENDEDOR, r.total as TOTAL, r.fecha as FECHA_EMISION, r.fechaingreso as FECHA_INGRESO, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM recibopago r inner join vendedor v on r.idvendedor=v.id_vendedor inner join clientes c on r.idcliente=c.idcliente where (r.tipo=4 or r.tipo=5) and r.cia=" + ControlSoftware.cia + " and r.numero_recibo between " + dnumero.getText() + " and " + hnumero.getText() + " order by r.fechaingreso desc", Productos);
                ...
                if (date2.compareTo(date1) == -1) {
                    ...
                    bd.LlenarTabla("select r.id_recibo AS COD, r.numero_recibo AS NRECIBO, CASE r.tipo WHEN '4' THEN 'AJUSTE-CREDITO' WHEN '5' THEN 'AJUSTE-DEBITO' END AS TIPO, c.nombre as CLIENTE, v.vendedor as VENDEDOR, r.total as TOTAL, r.fecha as FECHA_EMISION, r.fechaingreso as FECHA_INGRESO, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM recibopago r inner join vendedor v on r.idvendedor=v.id_vendedor inner join clientes c on r.idcliente=c.idcliente where (r.tipo=4 or r.tipo=5) and r.cia=" + ControlSoftware.cia + " and r.fechaingreso between '" + Date_Format.format(dfecha.getDate()) + "' and '" + Date_Format.format(hfecha.getDate()) + "'" + " order by r.fechaingreso desc", Productos);
                }
            } else if (pcliente.isSelected() && !cliente.getText().isEmpty()) {
                bd.LlenarTabla("select r.id_recibo AS COD, r.numero_recibo AS NRECIBO, CASE r.tipo WHEN '4' THEN 'AJUSTE-CREDITO' WHEN '5' THEN 'AJUSTE-DEBITO' END AS TIPO, c.nombre as CLIENTE, v.vendedor as VENDEDOR, r.total as TOTAL, r.fecha as FECHA_EMISION, r.fechaingreso as FECHA_INGRESO, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM recibopago r inner join vendedor v on r.idvendedor=v.id_vendedor inner join clientes c on r.idcliente=c.idcliente where (r.tipo=4 or r.tipo=5) and r.cia=" + ControlSoftware.cia + " and c.nombre like '%" + cliente.getText() + "%'" + " order by r.fechaingreso desc", Productos);
                ...
                if (date2.compareTo(date1) == -1) {
                    ...
                    bd.LlenarTabla("select r.id_recibo AS COD, r.numero_recibo AS NRECIBO, CASE r.tipo WHEN '4' THEN 'AJUSTE-CREDITO' WHEN '5' THEN 'AJUSTE-DEBITO' END AS TIPO, c.nombre as CLIENTE, v.vendedor as VENDEDOR, r.total as TOTAL, r.fecha as FECHA_EMISION, r.fechaingreso as FECHA_INGRESO, CASE r.estado WHEN '0' THEN 'ANULADO' WHEN '1' THEN 'ACTIVO' END as ESTADO FROM recibopago r inner join vendedor v on r.idvendedor=v.id_vendedor inner join clientes c on r.idcliente=c.idcliente where (r.tipo=4 or r.tipo=5) and r.cia=" + ControlSoftware.cia + " and c.nombre like '%" + cliente.getText() + "%'" + " and r.fechaingreso between '" + Date_Format.format(dfecha.getDate()) + "' and '" + Date_Format.format(hfecha.getDate()) + "'" + " and r.numero_recibo between " + dnumero.getText() + " and " + hnumero.getText() + " order by r.fechaingreso desc", Productos);
                }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!bd.versiesta("select * from role_usuario inner join role on role.id=role_usuario.roleid inner join usuario on usuario.cod_user=role_usuario.usuarioid inner join role_permiso on role_permiso.roleid=role.id inner join permisos on permisos.id=role_permiso.permisoid where permisos.id=" + perm + " and role_usuario.cia=" + ControlSoftware.cia + " and usuario.cod_user=" + ControlSoftware.us)) {
            JOptionPane.showMessageDialog(null, "Usted no tiene acceso a ingresar ajustes de débito.");
            return;
        }
        ajustededebito l = new ajustededebito("", "");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Ingreso_de_credenciales dialog = new Ingreso_de_credenciales("125");
        ...
        try {
            ...
            int opc = 0;
            opc = JOptionPane.showConfirmDialog(null, "Desea anular este ajuste? se eliminarán todos los pagos a todas las facturas.");
            if (opc == 0) {
                
                
                if(Productos.getValueAt(Productos.getSelectedRow(), 2).equals("AJUSTE-CREDITO")){
                ...
                JOptionPane.showMessageDialog(null, "Ajuste anulado con éxito");
                }
                
                if(Productos.getValueAt(Productos.getSelectedRow(), 2).equals("AJUSTE-DEBITO")){
                bd.LlenarTabla("select * from detalle_recibopago where idrecibo=" + rec, temp);
                for (int i = 0; i < temp.getRowCount(); i++) {
                    bd.EjecutarConsultas("update factura set saldo=saldo-" + temp.getValueAt(i, 3) + " where idfactura=" + temp.getValueAt(i, 2));
                    if (bd.valor("select saldo from factura where idfactura=" + temp.getValueAt(i, 2)).equals(bd.valor("select total from factura where idfactura=" + temp.getValueAt(i, 2)))) {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
          String perm="126";
        if (!bd.versiesta("select * from role_usuario inner join role on role.id=role_usuario.roleid inner join usuario on usuario.cod_user=role_usuario.usuarioid inner join role_permiso on role_permiso.roleid=role.id inner join permisos on permisos.id=role_permiso.permisoid where permisos.id=" + perm + " and role_usuario.cia=" + ControlSoftware.cia + " and usuario.cod_user=" + ControlSoftware.us)) {
            JOptionPane.showMessageDialog(null, "Usted no tiene acceso a eliminar ajustes.");
            return;
        }
        if (Productos.getSelectedRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Ninguna fila seleccionada!");
        ...
        try {
            ...
            int opc = 0;
            opc = JOptionPane.showConfirmDialog(null, "Desea eliminar este ajuste? se eliminarán todos los pagos a todas las facturas.");
            if (opc == 0) {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
          String perm="127";
        if (!bd.versiesta("select * from role_usuario inner join role on role.id=role_usuario.roleid inner join usuario on usuario.cod_user=role_usuario.usuarioid inner join role_permiso on role_permiso.roleid=role.id inner join permisos on permisos.id=role_permiso.permisoid where permisos.id=" + perm + " and role_usuario.cia=" + ControlSoftware.cia + " and usuario.cod_user=" + ControlSoftware.us)) {
            JOptionPane.showMessageDialog(null, "Usted no tiene acceso a reimprimir ajustes.");
            return;
        }
        if (Productos.getSelectedRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Ninguna fila seleccionada!");
        ...
        try {
            ...
            String path = "/ajustecredito.jasper";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
         String perm="122";
        if (!bd.versiesta("select * from role_usuario inner join role on role.id=role_usuario.roleid inner join usuario on usuario.cod_user=role_usuario.usuarioid inner join role_permiso on role_permiso.roleid=role.id inner join permisos on permisos.id=role_permiso.permisoid where permisos.id=" + perm + " and role_usuario.cia=" + ControlSoftware.cia + " and usuario.cod_user=" + ControlSoftware.us)) {
            JOptionPane.showMessageDialog(null, "Usted no tiene acceso a ingresar ajustes de crédito.");
            return;
        }
        ajustedecredito l = new ajustedecredito("", "");
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mantenimiento_ajustes_de_cuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mantenimiento_ajustes_de_cuenta().setVisible(true);
            }
        });
    }
