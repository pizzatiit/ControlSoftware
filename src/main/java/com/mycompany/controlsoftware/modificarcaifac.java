 ...
 * @author Usuario
 */
public class modificarcaifac extends javax.swing.JInternalFrame {
...
String id1="";
    public modificarcaifac(String id) {
        ...
        cai.setText(bd.valor("SELECT CAI FROM HISTORICO_CAIFACTURA WHERE ID=" + id + " and cia=" + ControlSoftware.cia));
        ri.setText(bd.valor("SELECT RANGO_INICIAL FROM HISTORICO_CAIFACTURA WHERE ID=" + id + " and cia=" + ControlSoftware.cia));
        rf.setText(bd.valor("SELECT RANGO_FINAL FROM HISTORICO_CAIFACTURA WHERE ID=" + id + " and cia=" + ControlSoftware.cia));
        id1=id;
        try {
            Date date = new SimpleDateFormat("yyyy-MM-dd").parse(bd.valor("SELECT FECHA_INICIAL FROM HISTORICO_CAIFACTURA WHERE ID=" + id + " and cia=" + ControlSoftware.cia));
            fi.setDate(date);
        } catch (Exception e) {
            System.out.println(e);
        }
        try {
            Date date = new SimpleDateFormat("yyyy-MM-dd").parse(bd.valor("SELECT FECHA_FINAL FROM HISTORICO_CAIFACTURA WHERE ID=" + id + " and cia=" + ControlSoftware.cia));
            ff.setDate(date);
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarActionPerformed
        ...
        if (input == 0) {
            try {
                ...
                bd.EjecutarConsultas("UPDATE `historico_caifactura` SET `cai`='"+cai.getText()+"',`fecha_inicial`='"+Date_Format.format(fi.getDate())+"',`fecha_final`='"+Date_Format.format(ff.getDate())+"',`rango_inicial`='"+ri.getText()+"',`rango_final`='"+rf.getText()+"' WHERE id="+id1+" and cia="+ControlSoftware.cia);
                configuraciones_cai_facturas l = new configuraciones_cai_facturas();
                Dimension internalFrameSize = l.getSize();
                Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
                l.setLocation((screenSize.width - internalFrameSize.width) / 2,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modificarcaifac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificarcaifac("").setVisible(true);
            }
        });
    }
