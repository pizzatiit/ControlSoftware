...
public class modificarVendedor extends javax.swing.JInternalFrame {
    ...
    public modificarVendedor(String v) {
        ...
        nombre.setText(bd.valor("select vendedor from vendedor where id_vendedor=" + v+" and cia="+ControlSoftware.cia));
        sueldo.setText(bd.valor("select sueldo from vendedor where id_vendedor=" + v+" and cia="+ControlSoftware.cia));
        deducciones.setText(bd.valor("select deducciones from vendedor where id_vendedor=" + v+" and cia="+ControlSoftware.cia));
        sueldoneto.setText(bd.valor("select sueldo_neto from vendedor where id_vendedor=" + v+" and cia="+ControlSoftware.cia));
        try {
            Date date = new SimpleDateFormat("yyyy-MM-dd").parse(bd.valor("select fecha_ingreso from vendedor where id_vendedor=" + v));
            fecha.setDate(date);
        } catch (Exception e) {
            System.out.println(e);
        }
        direccion.setText(bd.valor("select direccion from vendedor where id_vendedor=" + v+" and cia="+ControlSoftware.cia));
        telefono.setText(bd.valor("select telefono from vendedor where id_vendedor=" + v+" and cia="+ControlSoftware.cia));

        z = v;
//        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/guardar.png")));
//        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/back.png")));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bd.EjecutarConsultas(
                "UPDATE `vendedor` SET`vendedor`='" + nombre.getText() + "',`fecha_ingreso`='" + Date_Format.format(fecha.getDate()) + "',`sueldo`='" + sueldo.getText() + "',`deducciones`='" + deducciones.getText() + "',`sueldo_neto`='" + sueldoneto.getText() + "',`direccion`='" + direccion.getText() + "',`telefono`='" + telefono.getText() + "' WHERE id_vendedor=" + z+" and cia="+ControlSoftware.cia);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificarVendedor("1").setVisible(true);
            }
        });
    }
