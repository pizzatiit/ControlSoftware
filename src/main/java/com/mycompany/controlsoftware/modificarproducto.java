...
public class modificarproducto extends javax.swing.JInternalFrame {
    ...
    public modificarproducto(int se, int cambio) {
        ...
        costoiniciallempiras.setText("" + bd.valor("select case when arancel !=0 then preciocompra/(1+arancel/100) else preciocompra end as costoiniciallempiras from producto where idproducto="+temp+" and cia="+ControlSoftware.cia));
        ...
        costoinicialdolar.setText("" + bd.valor("select case when arancel !=0 then preciocompradolares/(1+arancel/100) else preciocompradolares end as costoinicialdolares from producto where idproducto="+temp+" and cia="+ControlSoftware.cia));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        // TODO add your handling code here:
        seleccionar_marca1 l = new seleccionar_marca1();
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            System.out.println(""+costofinallempiras.getText());
