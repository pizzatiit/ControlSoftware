 ...
 * @author Usuario
 */
public class mantenimiento_usuarios extends javax.swing.JInternalFrame {
    ...
    public mantenimiento_usuarios() {
        ...
        initComponents();
        bd.LlenarTabla("select COD_USER AS COD, USER AS USUARIO, STATE AS ESTADO FROM USUARIO", Productos);
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("MANTENIMIENTO USUARIOS");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(buscar, javax.swing.GroupLayout.PREFERRED_SIZE, 492, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(128, 128, 128))
        );
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 577, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        u_usuario l = new u_usuario(""+Productos.getValueAt( Productos.getSelectedRow(),0));
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
            (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!buscar.getText().isEmpty()) {
             bd.LlenarTabla("select COD_USER AS COD, USER AS USUARIO, STATE AS ESTADO FROM USUARIO where cia=" + ControlSoftware.cia+" and USER like '%"+buscar.getText()+"%'", Productos);
            
           } else {
            bd.LlenarTabla("select COD_USER AS COD, USER AS USUARIO, STATE AS ESTADO FROM USUARIO where cia=" + ControlSoftware.cia, Productos);
        }
