 ...
 * @author Usuario
 */
public class u_banco extends javax.swing.JInternalFrame {
    ...
    public u_banco(String id) {
        ...
        initComponents();
        nombre.setText("" + bd.valor("select nombre from banco where idbanco=" + id + " and cia=" + ControlSoftware.cia));
        id1 = id;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bd.EjecutarConsultas("update banco set nombre='" + nombre.getText() + "' where idbanco=" + id1 + " and cia=" + ControlSoftware.cia);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(u_banco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
