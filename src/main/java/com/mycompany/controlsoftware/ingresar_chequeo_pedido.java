 ...
 * @author Usuario
 */
public class ingresar_chequeo_pedido extends javax.swing.JInternalFrame {
    ...
    public ingresar_chequeo_pedido() {
...
//        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/printer72.png")));
        ...
        if (bd.valor("select max(cast(numero_pedido as unsigned))+1 as maximo from pedidochequeo where cia=" + ControlSoftware.cia) == null) {
            pedido.setText("1");
        } else {
            pedido.setText(String.format("%.0f", (Double.parseDouble(bd.valor("select max(cast(numero_pedido as unsigned))+1 as maximo from pedidochequeo where cia=" + ControlSoftware.cia)))));
        }
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        seleccionarcliente_chequeo_bodega l = new seleccionarcliente_chequeo_bodega();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (pedido.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe seleccionar cliente");
            return;
        }
        if (bd.versiesta("select * from pedidochequeo where numero_pedido=" + pedido.getText() + " and cia=" + ControlSoftware.cia)) {
            JOptionPane.showMessageDialog(null, "No puede ingresar un numero de pedido ya existente");
            return;
        }
        ...
        try {
            ...
            String cp = bd.doble("INSERT INTO `pedidochequeo`(`numero_pedido`, `id_cliente`, `fecha_sistema`, `fecha_pedido`, `id_usuario`, `estado`, `cia`) VALUES ('" + pedido.getText() + "','" + codcliente.getText() + "','" + LocalDateTime.now() + "','" + Date_Format.format(fecha.getDate()) + "','" + ControlSoftware.us + "','1','" + ControlSoftware.cia + "')", "SELECT @@IDENTITY AS 'id'");
            for (int i = 0; i < detalle.getRowCount(); i++) {
                bd.EjecutarConsultas("INSERT INTO `detalle_pedido_chequeo_bodega`(`id_pedido_bodega`, `id_producto`, `cantidad`, `fecha`, `idusuario`, `estado`, `cia`) VALUES ('" + cp + "','" + detalle.getValueAt(i, 0) + "','" + detalle.getValueAt(i, 3) + "','" + Date_Format.format(fecha.getDate()) + "','" + detalle.getValueAt(i, 4) + "','1','" + ControlSoftware.cia + "')");
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ingresar_chequeo_pedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ingresar_chequeo_pedido().setVisible(true);
            }
        });
    }
