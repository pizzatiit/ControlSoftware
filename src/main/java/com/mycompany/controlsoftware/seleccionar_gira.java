 ...
 * @author Usuario
 */
public class seleccionar_gira extends javax.swing.JFrame {
     ...
     */BaseDeDatos bd = new BaseDeDatos();
     int y;
    public seleccionar_gira(int cambio) {
        ...
        bd.LlenarTabla("select G.id_gira as COD, G.GIRA AS GIRA, V.VENDEDOR AS VENDEDOR  from gira G INNER JOIN VENDEDOR V ON V.ID_VENDEDOR=G.ID_VENDEDOR where G.cia="+ControlSoftware.cia, jTable1);
        y=cambio;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("SELECCIONE GIRA");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            if (y==1){
          //  nuevocliente.codcat2.setText(cod.getText());
          //  nuevocliente.descat2.setText(descripcion.getText());
            }if(y==2){
          //  modificarcliente.codcat2.setText(cod.getText());
          //  modificarcliente.descat2.setText(descripcion.getText());
            }
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_gira.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_gira(1).setVisible(true);
            }
        });
    }
