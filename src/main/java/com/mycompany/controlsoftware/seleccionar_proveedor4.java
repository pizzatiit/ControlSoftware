 ...
 * @author Usuario
 */
public class seleccionar_proveedor4 extends javax.swing.JInternalFrame {

    /**
     * Creates new form seleccionar_proveedor
     */
    BaseDeDatos bd = new BaseDeDatos();
    public seleccionar_proveedor4() {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            estado_de_cuenta_proveedores.codcliente.setText(cod.getText());
            estado_de_cuenta_proveedores.descliente.setText(descripcion.getText());
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_proveedor4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_proveedor4().setVisible(true);
            }
        });
    }
