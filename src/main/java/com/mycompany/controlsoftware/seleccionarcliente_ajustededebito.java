 ...
 * @author Usuario
 */
public class seleccionarcliente_ajustededebito extends javax.swing.JInternalFrame {
    ...
    public seleccionarcliente_ajustededebito() {
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            ajustededebito.codcliente.setText(u);
            ajustededebito.descliente.setText(v);
            String facts[] = bd.Llenar("select idfactura from factura where estado!=0 and condicionpago=0 and idcliente=" + u + " and cia=" + ControlSoftware.cia, "idfactura");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionarcliente_ajustededebito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionarcliente_ajustededebito().setVisible(true);
            }
        });
    }
