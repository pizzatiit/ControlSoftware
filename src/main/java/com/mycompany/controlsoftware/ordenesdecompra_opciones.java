 ...
 * @author Usuario
 */
public class ordenesdecompra_opciones extends javax.swing.JInternalFrame {
    ...
    public ordenesdecompra_opciones() {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ORDENES DE COMPRA");
        ...
        mostrarsaldos.setText("Filtrar por fecha");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String fi = bd.valor("select min(fecha_ingreso) from ordencompra where cia=" + ControlSoftware.cia);

        String ff = bd.valor("select max(fecha_ingreso) from ordencompra where cia=" + ControlSoftware.cia);
        dfecha=fi;
        hfecha=ff;
        ...
        try {
            ...
            String path = "/informedeordenesporproveedor.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ordenesdecompra_opciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ordenesdecompra_opciones().setVisible(true);
            }
        });
    }
