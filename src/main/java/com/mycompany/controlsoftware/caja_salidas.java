...
public class caja_salidas extends javax.swing.JInternalFrame {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(password1, javax.swing.GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE)
                            .addComponent(monto, javax.swing.GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(caja.valoractual().doubleValue()< new BigDecimal(monto.getText()).doubleValue()){
            JOptionPane.showMessageDialog(null, "El monto a retirar es mayor al monto existente en caja");
            return;
        }
        ...
        try{
         URL url1=new URL(ControlSoftware.url + "usuario/login" + "?user=" + bd.valor("select user from usuario where cod_user=" + ControlSoftware.us) + "&password=" + password1.getText());
            ...
            URL url = new URL(ControlSoftware.url+"caja/salidacaja");
            ...
            String parametros = "monto="+monto.getText()+"&observacion="+observacion.getText()+"&cia="+ControlSoftware.cia+"&idcaja="+getCaja();
            ...
            JOptionPane.showMessageDialog(null,"Registrado correctamente." + response.toString());
            jButton5.doClick();
            // Cerrar la conexión
