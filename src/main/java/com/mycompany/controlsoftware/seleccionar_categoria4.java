    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            dispose();
              ...
              if(s.equals("3")){
            comprobarinventario_opciones.codcat.setText(cod.getText());
            comprobarinventario_opciones.descat.setText(descripcion.getText());
            dispose();
            }
               if(s.equals("4")){
            ...
            dispose();
               ...
               if(s.equals("5")){
            catalogodeprecios_opciones.codcat.setText(cod.getText());
            catalogodeprecios_opciones.descat.setText(descripcion.getText());
            dispose();
            }
               if(s.equals("6")){
