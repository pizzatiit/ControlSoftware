 ...
 * @author Usuario
 */
public class seleccionar_proveedor3 extends javax.swing.JInternalFrame {

    /**
     * Creates new form seleccionar_proveedor
     */
    BaseDeDatos bd = new BaseDeDatos();
    public seleccionar_proveedor3() {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            ModificarOC.codprov.setText(cod.getText());
            ModificarOC.desprov.setText(descripcion.getText());
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_proveedor3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_proveedor3().setVisible(true);
            }
        });
    }
