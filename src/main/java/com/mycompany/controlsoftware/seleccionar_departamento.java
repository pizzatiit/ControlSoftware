 ...
 * @author Usuario
 */
public class seleccionar_departamento extends javax.swing.JInternalFrame {

    /**
     * Creates new form seleccionar_categoria
     */BaseDeDatos bd = new BaseDeDatos();
     int y;
    public seleccionar_departamento(int cambio) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            if (y==1){
            nuevocliente.codcat.setText(cod.getText());
            nuevocliente.descat.setText(descripcion.getText());
            }if(y==2){
            modificarcliente.codcat.setText(cod.getText());
            modificarcliente.descat.setText(descripcion.getText());
            }
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_departamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_departamento(1).setVisible(true);
            }
        });
    }
