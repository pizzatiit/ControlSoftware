 ...
 * @author Usuario
 */
public class u_departamento extends javax.swing.JInternalFrame {
    ...
    public u_departamento(String x) {
        ...
        nombre.setText("" + bd.valor("select departamento from departamento where id_departamento=" + x));
        comodin.setText("" + bd.valor("select comodin from departamento where id_departamento=" + x));
        cod = x;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bd.EjecutarConsultas("update departamento set departamento='" + nombre.getText() + "', comodin='" + comodin.getText() + "' where id_departamento=" + cod);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(u_departamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new u_departamento("0").setVisible(true);
            }
        });
    }
