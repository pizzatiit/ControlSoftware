 ...
 * @author Usuario
 */
public class mantenimiento_marcas extends javax.swing.JInternalFrame {
    ...
    public mantenimiento_marcas() {
        ...
        initComponents();
        bd.LlenarTabla("select idmarca as COD, marca as MARCA, comision as COMISION, DESCUENTO AS DESCUENTO from MARCA where cia=" + ControlSoftware.cia, Productos);
        Productos.setDefaultRenderer(Object.class, new MiRendererMarca());
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!bd.versiesta("select * from role_usuario inner join role on role.id=role_usuario.roleid inner join usuario on usuario.cod_user=role_usuario.usuarioid inner join role_permiso on role_permiso.roleid=role.id inner join permisos on permisos.id=role_permiso.permisoid where permisos.id=" + perm + " and role_usuario.cia=" + ControlSoftware.cia + " and usuario.cod_user=" + ControlSoftware.us)) {
            JOptionPane.showMessageDialog(null, "Usted no tiene permiso de ingresar marcas de productos.");
            return;
        }

        i_marca l = new i_marca();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        u_marca l = new u_marca("" + Productos.getValueAt(Productos.getSelectedRow(), 0));
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!buscar.getText().isEmpty()) {
            bd.LlenarTabla("select idmarca as ID, MARCA AS MARCA, COMISION AS COMISION, DESCUENTO AS DESCUENTO from MARCA where marca like '%" + buscar.getText() + "%' and cia=" + ControlSoftware.cia, Productos);

        } else {
            bd.LlenarTabla("select idmarca as ID, MARCA AS MARCA, COMISION AS COMISION, DESCUENTO AS DESCUENTO from MARCA where cia=" + ControlSoftware.cia, Productos);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mantenimiento_marcas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mantenimiento_marcas().setVisible(true);
            }
        });
    }
