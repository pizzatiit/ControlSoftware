 ...
 * @author Usuario
 */
public class seleccionarfactura_descuento extends javax.swing.JInternalFrame {
    ...
    public seleccionarfactura_descuento() {
        ...
        initComponents(); 
        bd.LlenarTabla("select f.idfactura as ID, f.numerofactura as FACTURA_FISCAL, c.nombre as CLIENTE, v.vendedor as VENDEDOR, CASE f.condicionpago WHEN '1' THEN 'CONTADO' WHEN '0' THEN 'CREDITO' END as METODO_PAGO, CASE f.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, f.fechafactura as FECHA_FACTURA,  f.total as TOTAL,f.saldo as SALDO, CASE f.estado WHEN '1' THEN 'ACTIVA' WHEN '0' THEN 'ANULADA' WHEN '3' THEN 'PAGADA' WHEN '2' THEN 'ABONADA' END AS ESTADO,f.totalfinal as TOTALF, F.DESCUENTO AS DESCUENTO  from factura as f inner join clientes as c on c.idcliente=f.idcliente inner join vendedor v on f.idvendedor=v.id_vendedor where f.cia=" + ControlSoftware.cia+" order by f.idfactura desc" , Productos);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (ninguno.isSelected()) {
                ...
                bd.LlenarTabla("select f.idfactura as ID, f.numerofactura as FACTURA_FISCAL, c.nombre as CLIENTE, v.vendedor as VENDEDOR, CASE f.condicionpago WHEN '1' THEN 'CONTADO' WHEN '0' THEN 'CREDITO' END as METODO_PAGO, CASE f.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, f.fechafactura as FECHA_FACTURA,  f.total as TOTAL,f.saldo as SALDO, CASE f.estado WHEN '1' THEN 'ACTIVA' WHEN '0' THEN 'ANULADA' WHEN '3' THEN 'PAGADA' WHEN '2' THEN 'ABONADA' END AS ESTADO,f.totalfinal as TOTALF, F.DESCUENTO AS DESCUENTO from factura as f inner join clientes as c on c.idcliente=f.idcliente inner join vendedor v on f.idvendedor=v.id_vendedor where f.cia=" + ControlSoftware.cia + " and f.numerofactura like '%" + p.getText() + "%'"+" order by f.idfactura desc", Productos);
                ...
                if (date2.compareTo(date1) == -1) {
                    ...
                    bd.LlenarTabla("select f.idfactura as ID, f.numerofactura as FACTURA_FISCAL, c.nombre as CLIENTE, v.vendedor as VENDEDOR, CASE f.condicionpago WHEN '1' THEN 'CONTADO' WHEN '0' THEN 'CREDITO' END as METODO_PAGO, CASE f.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, f.fechafactura as FECHA_FACTURA,  f.total as TOTAL,f.saldo as SALDO, CASE f.estado WHEN '1' THEN 'ACTIVA' WHEN '0' THEN 'ANULADA' WHEN '3' THEN 'PAGADA' WHEN '2' THEN 'ABONADA' END AS ESTADO,f.totalfinal as TOTALF, F.DESCUENTO AS DESCUENTO  from factura as f inner join clientes as c on c.idcliente=f.idcliente inner join vendedor v on f.idvendedor=v.id_vendedor where f.cia=" + ControlSoftware.cia + " and f.fechaingreso between '" + Date_Format.format(d.getDate()) + "' and '" + Date_Format.format(h.getDate()) + "'"+" order by f.idfactura desc", Productos);
                }
            } else if (ambos.isSelected() && !p.getText().isEmpty() && !d.getDate().equals("") && !h.getDate().equals("")) {
                bd.LlenarTabla("select f.idfactura as ID, f.numerofactura as FACTURA_FISCAL, c.nombre as CLIENTE, v.vendedor as VENDEDOR, CASE f.condicionpago WHEN '1' THEN 'CONTADO' WHEN '0' THEN 'CREDITO' END as METODO_PAGO, CASE f.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, f.fechafactura as FECHA_FACTURA,  f.total as TOTAL,f.saldo as SALDO, CASE f.estado WHEN '1' THEN 'ACTIVA' WHEN '0' THEN 'ANULADA' WHEN '3' THEN 'PAGADA' WHEN '2' THEN 'ABONADA' END AS ESTADO,f.totalfinal as TOTALF, F.DESCUENTO AS DESCUENTO  from factura as f inner join clientes as c on c.idcliente=f.idcliente inner join vendedor v on f.idvendedor=v.id_vendedor where f.cia=" + ControlSoftware.cia + " and f.fechaingreso between '" + Date_Format.format(d.getDate()) + "' and '" + Date_Format.format(h.getDate()) + "' and f.numerofactura like '%" + p.getText() + "%'"+" order by f.idfactura desc", Productos);
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        ingresardescuento.idfact.setText(""+idf);
        ingresardescuento.nfact.setText(""+nf);
        ingresardescuento.total.setText(""+Productos.getValueAt(Productos.getSelectedRow(), 7));
        ingresardescuento.totalfinal.setText(""+Productos.getValueAt(Productos.getSelectedRow(), 10));
        ingresardescuento.descuento.setText(""+Productos.getValueAt(Productos.getSelectedRow(), 11));
        dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionarfactura_descuento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionarfactura_descuento().setVisible(true);
            }
        });
    }
