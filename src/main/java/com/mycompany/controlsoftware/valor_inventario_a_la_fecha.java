 ...
 * @author Usuario
 */
public class valor_inventario_a_la_fecha extends javax.swing.JInternalFrame {
    ...
    public valor_inventario_a_la_fecha() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        date2 = hastafecha.getDate();
            ...
            String path = "/inventarioaunafecha.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(valor_inventario_a_la_fecha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new valor_inventario_a_la_fecha().setVisible(true);
            }
        });
    }
