 ...
 * @author Usuario
 */
public class nuevocainc extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("INGRESAR CAI NC");
    ...
    private void confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarActionPerformed
        ...
        if (input == 0) {
            try {
                ...
                bd.EjecutarConsultas("INSERT INTO `HISTORICO_CAINOTACREDITO`(`cai`, `cia`, `fecha_inicial`, `fecha_final`, `rango_inicial`, `rango_final`, `estado`) VALUES ('" + cai.getText() + "','" + ControlSoftware.cia + "','" + Date_Format.format(fi.getDate()) + "','" + Date_Format.format(ff.getDate()) + "','" + ri.getText() + "','" + rf.getText() + "','1')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nuevocainc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nuevocainc().setVisible(true);
            }
        });
    }
