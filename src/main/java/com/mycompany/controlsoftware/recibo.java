...
public class recibo extends javax.swing.JInternalFrame {
    ...
    public recibo(String cl, String f) {
        ...
        modelo.addTableModelListener(e -> {
                ...
                if (abonoValue != null) {
                    ...
                    if (!abonoString.matches("\\d+(\\.\\d*)?|\\.\\d+")) {
                        ...
                        if (Double.parseDouble("" + santerior) < Double.parseDouble("" + abonoValue)) {
                            ...
                            grantotal.setText(""+(sumaAbono+ new BigDecimal(gtotal1.getText()).doubleValue()));
                        }
                    }
                }
            }
         ...
         modelo.addTableModelListener(e -> {
            if (e.getColumn() == 6) {
                int row = e.getFirstRow();
                Object abonoValue = modelo.getValueAt(row, 6);
                ...
                if (abonoValue != null) {
                    ...
                    if (!abonoString.matches("\\d+(\\.\\d*)?|\\.\\d+")) {
                        JOptionPane.showMessageDialog(
                                null,
                                "El valor de Abono a interes debe ser un número válido.",
                                "Error",
                                JOptionPane.ERROR_MESSAGE
                        );
                        SwingUtilities.invokeLater(() -> {
                            recibos.editCellAt(row, 6);
                            recibos.getEditorComponent().requestFocusInWindow();
                        });
                    } else {
                        Object santerior = modelo.getValueAt(row, 5);
                       // Object sfinal = Double.parseDouble("" + santerior) - Double.parseDouble("" + abonoValue);
                        if (Double.parseDouble("" + santerior) < Double.parseDouble("" + abonoValue)) {
                            JOptionPane.showMessageDialog(null, "El abono no puede ser mayor que el saldo.");
                            SwingUtilities.invokeLater(() -> {
                           ...
                           // modelo.setValueAt(sfinal, row, 4);
                            ...
                            for (int u = 0; u < modelo.getRowCount(); u++) {
                                Object abonoValue1 = modelo.getValueAt(u, 6);
                                if (abonoValue1 != null) {
                                    try {
                                        BigDecimal abono = new BigDecimal(abonoValue1.toString());
                                        sumaAbono = sumaAbono.add(abono);
                                    } catch (NumberFormatException ignored) {
                                    }
                                }
                            }
                            gtotal1.setText("" + sumaAbono);
                            grantotal.setText(""+(sumaAbono.add(new BigDecimal(gtotal.getText()))));
                        }
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        grantotal = new javax.swing.JTextField();
        ...
        recibos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID FACTURA", "NUMERO", "SALDO ANTERIOR", "ABONO", "NUEVO SALDO", "INTERESES", "ABONO INTERES"
            }
        ) {
        ...
        gtotal1.setEditable(false);
        gtotal1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        gtotal1.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ...
        grantotal.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        grantotal.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        jLabel19.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(0, 0, 0));
        jLabel19.setText("GRAN TOTAL");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(nrecibo, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(44, 44, 44)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(gtotal1, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(vend, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(grantotal, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(grantotal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(gtotal1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void recibosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_recibosMouseClicked
        // TODO add your handling code here:
             ...
             if(recibos.getSelectedColumn()==2){
                 recibos.setValueAt(recibos.getValueAt(recibos.getSelectedRow(), 2), recibos.getSelectedRow(), 3);
             }
             if(recibos.getSelectedColumn()==5){
                 recibos.setValueAt(recibos.getValueAt(recibos.getSelectedRow(), 5), recibos.getSelectedRow(), 6);
             }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        datosrecibo l = new datosrecibo(Double.parseDouble(gtotal.getText()),Double.parseDouble(gtotal1.getText()));
    ...
    public static javax.swing.JTextField grantotal;
    public static javax.swing.JTextField gtotal;
    public static javax.swing.JTextField gtotal1;
