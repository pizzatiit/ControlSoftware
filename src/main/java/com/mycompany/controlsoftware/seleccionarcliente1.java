 ...
 * @author Usuario
 */
public class seleccionarcliente1 extends javax.swing.JInternalFrame {
...
//        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/back.png")));
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            estadocuenta.codcliente.setText(u);
            estadocuenta.descliente.setText(v);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionarcliente1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionarcliente1().setVisible(true);
            }
        });
    }
