 ...
 * @author Usuario
 */
public class ajustedesalida extends javax.swing.JInternalFrame {
    ...
    public ajustedesalida() {
        ...
        if (bd.valor("select max(cast(n_documento as unsigned))+1 as maximo from ajusteinventario where cia=" + ControlSoftware.cia + " and tipo=1") == null) {
            factura.setText("1");
        } else {
            factura.setText(String.format("%.0f", (Double.parseDouble(bd.valor("select max(cast(n_documento as unsigned))+1 as maximo from ajusteinventario where cia=" + ControlSoftware.cia + " and tipo=1")))));
        }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("AJUSTE DE SALIDA");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (bd.versiesta("select n_documento from ajusteinventario where n_documento=" + factura.getText() + " and cia=" + ControlSoftware.cia + " and tipo=" + 1)) {
        ...
        if (factura.getText().isEmpty()) {
            ...
            if (opc == 0) {
                ...
                String cf = bd.doble("INSERT INTO `ajusteinventario`(`n_documento`, `tipo`, `fecha`, `totalcosto`, `cia`, `usuarioid`, `estado`, `observacion`) VALUES ('" + factura.getText() + "','1','" + LocalDateTime.now() + "','" + t + "','" + ControlSoftware.cia + "','" + ControlSoftware.us + "','1','" + obsfact.getText() + "')", "SELECT @@IDENTITY AS 'id'");
                ...
                for (int i = 0; i < detalle.getRowCount(); i++) {
                    ...
                    insertartransaccion("" + cf, "6", Double.parseDouble(bd.valor("select existencia from producto where idproducto=" + detalle.getValueAt(i, 0))), -Double.parseDouble("" + detalle.getValueAt(i, 3)), Double.parseDouble(bd.valor("select existencia from producto where idproducto=" + detalle.getValueAt(i, 0))) - Double.parseDouble("" + detalle.getValueAt(i, 3)), "" + detalle.getValueAt(i, 0));
    ...
    private void aggActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aggActionPerformed
        // TODO add your handling code here:
        seleccionar_producto_ajustesalida l = new seleccionar_producto_ajustesalida();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ajustedesalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ajustedesalida().setVisible(true);
            }
        });
    }
