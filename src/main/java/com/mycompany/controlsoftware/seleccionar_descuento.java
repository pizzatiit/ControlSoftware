 ...
 * @author Usuario
 */
public class seleccionar_descuento extends javax.swing.JFrame {

    /**
     * Creates new form seleccionar_categoria
     */BaseDeDatos bd = new BaseDeDatos();
     int y;
    public seleccionar_descuento(String x, int cambio) {
        ...
        bd.LlenarTabla("select ID_DESCUENTO AS COD, DESCUENTO AS DESCUENTO from descuento where cia="+ControlSoftware.cia, jTable1);
        y=cambio;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("SELECCIONE DESCUENTO");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            if (y==1){
          //  nuevocliente.codcat3.setText(cod.getText());
           // nuevocliente.descat3.setText(descripcion.getText());
            }if(y==2){
           // modificarcliente.codcat3.setText(cod.getText());
         //  modificarcliente.descat3.setText(descripcion.getText());
            }
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_descuento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_descuento("",1).setVisible(true);
            }
        });
    }
