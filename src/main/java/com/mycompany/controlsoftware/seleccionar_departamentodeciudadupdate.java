 ...
 * @author Usuario
 */
public class seleccionar_departamentodeciudadupdate extends javax.swing.JInternalFrame {
    ...
    public seleccionar_departamentodeciudadupdate() {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            u_ciudad.cod_depto.setText(cod.getText());
            u_ciudad.des_depto.setText(descripcion.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_departamentodeciudadupdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_departamentodeciudadupdate().setVisible(true);
            }
        });
    }
