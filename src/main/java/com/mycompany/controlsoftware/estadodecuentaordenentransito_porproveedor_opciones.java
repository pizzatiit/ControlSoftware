 ...
 * @author Usuario
 */
public class estadodecuentaordenentransito_porproveedor_opciones extends javax.swing.JInternalFrame {
    ...
    public estadodecuentaordenentransito_porproveedor_opciones() {
        ...
        initComponents();
               bd.LlenarCombo1("select idproveedor, proveedor from proveedor where cia=" + ControlSoftware.cia, ubicacion, "idproveedor", "proveedor");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Item pr=(Item) ubicacion.getSelectedItem();
             try {
                BaseDeDatos con = new BaseDeDatos();
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/ESTADO_CUENTA_ORDENES_EN_TRANSITO.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);

                Map<String, Object> parametros = new HashMap<>();
                parametros.put("cliente", pr.getId());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(estadodecuentaordenentransito_porproveedor_opciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new estadodecuentaordenentransito_porproveedor_opciones().setVisible(true);
            }
        });
    }
