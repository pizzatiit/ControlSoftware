 ...
 */
public class mantenimiento_recibos extends javax.swing.JInternalFrame {
...
//        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/back72.png")));
    ...
    private void initComponents() {
        ...
        jLabel10.setText("MANTENIMIENTO DE RECIBOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mantenimiento_recibos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mantenimiento_recibos().setVisible(true);
            }
        });
    }
