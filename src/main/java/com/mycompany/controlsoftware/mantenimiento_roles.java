 ...
 * @author Usuario
 */
public class mantenimiento_roles extends javax.swing.JInternalFrame {
    ...
    public mantenimiento_roles() {
        ...
        initComponents();
        bd.LlenarTabla("select id AS COD, ROLE AS ROLE, DESCRIPCION AS DESCRIPCION FROM ROLE", Productos);
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("MANTENIMIENTO ROLES");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        u_role l = new u_role(""+Productos.getValueAt( Productos.getSelectedRow(),0));
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
            (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!buscar.getText().isEmpty()) {
               bd.LlenarTabla("select id AS COD, ROLE AS ROLE, DESCRIPCION AS DESCRIPCION FROM ROLE WHERE ROLE like '%"+buscar.getText()+"%'", Productos);
           } else {
           bd.LlenarTabla("select id AS COD, ROLE AS ROLE, DESCRIPCION AS DESCRIPCION FROM ROLE", Productos);}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mantenimiento_roles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mantenimiento_roles().setVisible(true);
            }
        });
    }
